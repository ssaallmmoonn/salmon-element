...
import type { TranslatePair } from '@salmon-element/locale';
import English from '@salmon-element/locale/lang/en';
...
export function useGlobalConfig(key?: keyof ConfigProviderContext, defaultVal = void 0) {
