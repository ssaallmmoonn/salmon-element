...
import { useClickOutside } from '@salmon-element/hooks';
...
useClickOutside(containerNode as Ref<void | HTMLElement, void | HTMLElement>, () => {
	emits('click-outside');
...
<template>
	<div class="yis-tooltip" ref="containerNode" v-on="outerEvents">
		<div class="yis-tooltip__trigger" ref="_triggerNode" v-on="events" v-if="!virtualTriggering">
			<slot></slot>
		</div>
		<slot name="default" v-else></slot>

		<transition :name="transition" @after-leave="destroyPopperInstance">
			<div class="yis-tooltip__popper" ref="popperNode" v-on="dropdownEvents" v-if="visible">
				<slot name="content">
					{{ content }}
				</slot>
