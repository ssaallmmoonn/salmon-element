...
describe('MessageBox Component', () => {
	it('renders correctly', async () => {
		...
		MessageBox(props);
		await rAF();
		const header = document.querySelector('.yis-message-box__header');
		const title = document.querySelector('.yis-message-box__title');
		const message = document.querySelector('.yis-message-box__message');
	...
	it('closes on close button click', async () => {
		...
		const closeBtn = document.querySelector('.yis-message-box__header-btn') as HTMLButtonElement;
		closeBtn.click();
	...
	it('triggers confirm action on confirm button click', async () => {
		...
		const confirmBtn = document.querySelector('.yis-message-box__footer-btn') as HTMLButtonElement;
		confirmBtn.click();
		await rAF();
	...
	it('triggers cancel action on cancel button click', async () => {
		...
		const cancelBtn = document.querySelector('.yis-message-box__cancel-btn') as HTMLButtonElement;
		cancelBtn.click();
	...
	it('handles input in prompt mode', async () => {
		...
		const confirmBtn = document.querySelector('.yis-message-box__confirm-btn') as HTMLButtonElement;
		confirmBtn.click();
