...
describe('MessageBox Component', () => {
	...
	it('closes on close button click', async () => {
		...
		const closeBtn = document.querySelector('.er-message-box__header-btn') as HTMLButtonElement;
		closeBtn.click();
	...
	it('triggers confirm action on confirm button click', async () => {
		...
		const confirmBtn = document.querySelector('.er-message-box__footer-btn') as HTMLButtonElement;
		confirmBtn.click();
		await rAF();
	...
	it('triggers cancel action on cancel button click', async () => {
		...
		const cancelBtn = document.querySelector('.er-message-box__cancel-btn') as HTMLButtonElement;
		cancelBtn.click();
	...
	it('handles input in prompt mode', async () => {
		...
		const confirmBtn = document.querySelector('.er-message-box__confirm-btn') as HTMLButtonElement;
		confirmBtn.click();
