...
describe('ButtonGroup.vue', () => {
	test('basic button group', async () => {
		...
		expect(wrapper.classes()).toContain('yis-button-group');
	});
	...
	test('button group size', () => {
		...
		sizes.forEach(size => {
			...
			expect(buttonWrapper.classes()).toContain(`yis-button--${size}`);
		});
	});
	...
	test('button group type', () => {
		...
		types.forEach(type => {
			...
			const buttonWrapper = wrapper.findComponent(Button);
			expect(buttonWrapper.classes()).toContain(`yis-button--${type}`);
		});
	});
