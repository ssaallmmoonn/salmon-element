...
import { useFocusController } from '@salmon-element/hooks';
...
<template>
	...
	>
		<template v-if="type !== 'textarea'">
			<div v-if="$slots.prepend" class="yis-input__prepend">
				<slot name="prepend"></slot>
			</div>
			<div class="yis-input__wrapper" ref="wrapperRef">
				<span v-if="$slots.prefix" class="yis-input__prefix">
					<slot name="prefix"></slot>
				</span>
				<input
					class="yis-input__inner"
					ref="inputRef"
					:id="inputId"
					...
					@blur="handleBlur"
				/>
				<span v-if="$slots.suffix || showClear || showPwdArea" class="yis-input__suffix">
			...
			<div v-if="$slots.append" class="yis-input__append">
				<slot name="append"></slot>
			</div>
		</template>
		<template v-else>
			<textarea
				class="yis-textarea__wrapper"
				ref="textareaRef"
				:id="inputId"
				:disabled="isDisabled"
				:readonly="readonly"
