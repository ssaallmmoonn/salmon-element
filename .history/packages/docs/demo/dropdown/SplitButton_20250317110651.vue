...
import { type DropdownItemProps, YisMessage } from 'salmon-element';
...
<template>
	<div class="row">
		...
		<er-dropdown :items="items" type="primary" @click="handleClick" split-button>
			Dropdown List
		</er-dropdown>
	</div>
</template>
