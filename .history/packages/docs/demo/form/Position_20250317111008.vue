...
<template>
	<er-button-group size="small">
		...
		<er-button @click="labelPosition = 'top'" :type="labelPosition === 'top' ? 'primary' : 'info'">
			Top
		</er-button>
	</er-button-group>
	...
	<er-form :model="form" :label-position="labelPosition">
		...
		<er-form-item label="Activity zone">
			<er-select v-model="form.region" placeholder="please select your zone" :options="options" />
		</er-form-item>
